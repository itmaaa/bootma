							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label class="radio-inline">
										<input <#if  menu.type == 0 > checked </#if>  type="radio"  name="type" value="0" /> 目录
									</label> <label class="radio-inline">
									 	<input  <#if  menu.type == 1 > checked </#if> type="radio" name="type" value="1" /> 菜单
									</label> <label class="radio-inline">
										<input <#if  menu.type == 2 > checked </#if>  type="radio" name="type" value="2" /> 按钮
									</label>
								</div>
							</div>
							<div class="form-group">
